...
* The latest public release is [r2.3](https://github.com/hdamker/SimpleEdgeDiscovery/releases/tag/r2.3) (Fall25), with the following API versions:
  * **simple-edge-discovery 2.0.1**
  [[YAML]](https://github.com/hdamker/SimpleEdgeDiscovery/blob/r2.3/code/API_definitions/simple-edge-discovery.yaml)  [[ReDoc]](https://redocly.github.io/redoc/?url=https://raw.githubusercontent.com/hdamker/SimpleEdgeDiscovery/r2.3/code/API_definitions/simple-edge-discovery.yaml&nocors)  [[Swagger]](https://camaraproject.github.io/swagger-ui/?url=https://raw.githubusercontent.com/hdamker/SimpleEdgeDiscovery/r2.3/code/API_definitions/simple-edge-discovery.yaml)
...
* For changes see [CHANGELOG](https://github.com/hdamker/SimpleEdgeDiscovery/blob/main/CHANGELOG.md)
